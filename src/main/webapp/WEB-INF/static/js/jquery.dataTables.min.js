!function (t) {
    ...
    function O(e) {
        ...
        if (-1 === t.inArray(!1, n)) {
            var r = [], o = 0, i = e.asStripeClasses, l = i.length, s = (e.aoOpenRows.length, e.oLanguage), u = e.iInitDisplayStart, c = "ssp" == Mt(e), f = e.aiDisplay;
    ...
    var Ut, Vt, Xt, Jt, qt = function (e) {
        ...
        return this.each(function () {
            var h, p = {}, g = c > 1 ? Pt(p, e, !0) : e, b = 0, v = this.getAttribute("id"), S = !1, _ = qt.defaults, C = t(this);
            if ("table" == this.nodeName.toLowerCase()) {
                ...
                for (b = 0, h = T.length; b < h; b++) {
                    ...
                    if (x.nTable == this || x.nTHead.parentNode == this || x.nTFoot && x.nTFoot.parentNode == this) {
                        var I = g.bRetrieve !== a ? g.bRetrieve : _.bRetrieve, A = g.bDestroy !== a ? g.bDestroy : _.bDestroy;
